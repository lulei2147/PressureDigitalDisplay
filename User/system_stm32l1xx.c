...
/** @addtogroup STM32L1xx_System_Private_Variables
  * @{
  */
#define SYSTEMCORECLOCK_32000000HZ  32000000
#define SYSTEMCORECLOCK_4194304HZ   4194304
#define SYSTEMCORECLOCK_2097152HZ   2097152
#define SYSTEMCORECLOCK_1048576HZ   1048576

#define SYSTEMCORECLOCK             SYSTEMCORECLOCK_4194304HZ
...
/**
  ...
  * @retval None
  */
#if(SYSTEMCORECLOCK==1048576) // 1.048MHz
static void SetSysClock(void)
{
...
#elif(SYSTEMCORECLOCK==2097152)  // 2.097MHz
static void SetSysClock(void)
{
  __IO uint32_t  MSIStatus = 0;
...
#elif(SYSTEMCORECLOCK==4194304)  // 4.194MHz
static void SetSysClock(void)
{
  __IO uint32_t  MSIStatus = 0;
  /* SYSCLK, HCLK, PCLK2 and PCLK1 configuration ---------------------------*/
...
#elif (SYSTEMCORECLOCK==32000000)  // 32MHz
static void SetSysClock(void)
{
